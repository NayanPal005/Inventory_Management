                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="Dashboard/views/customer_info.jsp"><i class="fa fa-circle-o"></i> Add New</a></li>
                                <li><a href="Dashboard/views/CustomerLists.jsp"><i class="fa fa-circle-o"></i> Membership Info</a></li>
                            </ul>
                        </li>
                            ...
                            <ul class="treeview-menu">
                                <li><a href="Dashboard/views/user.jsp"><i class="fa fa-circle-o"></i> Add User</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="Dashboard/views/Dealership.jsp"><i class="fa fa-circle-o"></i> Add Dealer</a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                ...
                                <a href="Dashboard/customer.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-maroon">
                                ...
                                <a href="Dashboard/user.jsp" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /.row -->
