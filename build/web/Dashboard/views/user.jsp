                    ...
                    <table>
                        <tr> 
                            ...
                            <td><div class="form-group">
                                    ...
                                    <input type="username" class="form-control" id="pwd" placeholder="Enter Your Password">
                                </div><br></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="mobileno" class="form-control" id="mobileno" placeholder="Enter Your Mobile No">
                                </div><br>
                            </td>
                            ...
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="nid" class="form-control" id="nid" placeholder="Enter Your NID">
                                </div><br>
                            </td>
                        </tr>
                        <tr>
