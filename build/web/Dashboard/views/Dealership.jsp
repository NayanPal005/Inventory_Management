                    ...
                    <main>
                        <div class="panel panel-primary">
                            <div class="container">
                                ...
                                <form class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4" action="InsertDealer.jsp">
                                    <label><h1>Dealer Information</h1></label>
                                    <table>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label for="customer id">Dealer Name: </label><br>
                                                    <input type="customer id" class="form-control" name="dealer_name"  placeholder="Enter Product Name">
                                                </div><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label for=""><h3>Branch</h3> </label><br>
                                                    ...
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Narayanjgong</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Comilla</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Nowakhali</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Cox's Bazar</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Chandpur</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Rangamati</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Bandarban</label>
                                                    </div>
                                                    <div class="checkbox-circle">
                                                        <label><input type="checkbox" value="">Khagrachari</label>
                                                    </div>
    </div>
                                                </div>
                                                <br>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label for="customer id">Dealer Id</label><br>
                                                    <input type="customer id" class="form-control" name="dealer_id"  placeholder="Enter Your ID">
                                                </div><br>
                                            </td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label for="customer id">Contact</label><br>
                                                    <input type="customer id" class="form-control" name="contact" placeholder="Enter Your Contact">
                                                </div><br>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-group">
                                                    <label for="customer id">Address </label><br>
                                                    <textarea type="customer id" class="form-control" name="address" id="customer id" placeholder=""></textarea>
                                                </div><br>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <label for="customer id">Date</label><br>
                                                    <input type="text" class="form-control" name="date" placeholder="Enter Quantity">
                                                </div><br>
                                            </td>
